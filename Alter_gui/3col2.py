...
class RoverInterface(QMainWindow):
    def __init__(self):
        ...
        # Button stylesheet modifications
        button_stylesheet = """
            QPushButton {
        ...
        """
        autonomous_button.setStyleSheet(button_stylesheet)
        object_detection_button.setStyleSheet(button_stylesheet)
        settings_button.setStyleSheet(button_stylesheet)
        capture_button.setStyleSheet(button_stylesheet)
        ...
        for i in range(3):
            for j in range(3):
                ...
                button.setStyleSheet(button_stylesheet)  # Apply button stylesheet
        ...
        for flip_name in ["Front Left", "Front Right", "Rear Left", "Rear Right"]:
            ...
            raise_button.setStyleSheet(button_stylesheet)  # Apply button stylesheet
            lower_button.setStyleSheet(button_stylesheet)  # Apply button stylesheet
        ...
        emergency_stop.setStyleSheet(button_stylesheet)  # Apply button stylesheet
        stabilize.setStyleSheet(button_stylesheet)  # Apply button stylesheet
        ...
        log_status.setFont(QFont('Arial', 12, QFont.Bold))
        log_status.setStyleSheet("background-color: rgb(70, 70, 70); color: white; border: 1px solid gray")
        log_status.setAlignment(Qt.AlignCenter)
