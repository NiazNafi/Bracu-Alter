import sys
import cv2
from PyQt5.QtWidgets import QApplication, QMainWindow, QWidget, QVBoxLayout, QHBoxLayout, QLabel, QPushButton, QSlider, QTextEdit, QGridLayout, QFrame
...
class RoverInterface(QMainWindow):
    def __init__(self):
        ...
        # Create left layout for video feed
        ...
        # Create a horizontal layout for wheel and flipper controls
        ...
        wheel_control_layout = QVBoxLayout()
        speed_slider = QSlider(Qt.Vertical)
        wheel_control_layout.addWidget(speed_slider)
        ...
        wheel_control_layout.addLayout(wheel_grid)
        wheel_layout.addLayout(wheel_control_layout)
        controls_layout.addLayout(wheel_layout)
        ...
        controls_layout.addLayout(self.flipper_control_layout)
        ...
        control_panel_layout.addWidget(mode_status, 0, 0, 1, 2)

        autonomous_button = QPushButton("Go Autonomous")
        control_panel_layout.addWidget(autonomous_button, 1, 0, 1, 2)
        ...
        control_panel_layout.addWidget(object_detection_button, 2, 0)
        control_panel_layout.addWidget(settings_button, 2, 1)
        control_panel_layout.addWidget(capture_button, 3, 0, 1, 2)
